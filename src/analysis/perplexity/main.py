...
def main():
    ...
    bible_lemmas = extract_features_from_folder(bible_folder, feature='lex')
    
    print("Loading Mishnaic corpus...")
    mishna_lemmas = extract_features_from_folder(mishna_folder, feature='lex')
    
    print("Loading Modern corpus...")
    modern_lemmas = extract_features_from_folder(modern_folder, feature='lex')
    ...
    plt.title('Syntactic Surprise (Log Perplexity) in Modern Hebrew')
    ...
    save_path = os.path.join(current_dir, "perplexity_log_bars.png")

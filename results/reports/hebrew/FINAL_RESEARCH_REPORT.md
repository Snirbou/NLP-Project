...
## 6. הערכה אנושית (סקר מובנות)

במסגרת המחקר נערך סקר בקרב 50 דוברי עברית, בו הוצגו זוגות משפטים (מקראי וחז"לי) והם נתבקשו לדרג מובנות.

**ממצאים עיקריים:**
*   **לשון חז"ל:** נמצאה מובנת יותר ב-51.1% מהמקרים.
*   **לשון המקרא:** נמצאה מובנת יותר ב-48.9% מהמקרים.
*   **גורם הקושי:** בשתי השפות, מעל 40% מהנשאלים ציינו את **התחביר** (מבנה המשפט) כגורם הקושי העיקרי, יותר מאשר אוצר מילים.

**מסקנה:** למרות הפערים התחביריים, דוברי עברית מודרנית מוצאים את שתי השפות ההיסטוריות מובנות כמעט באותה מידה.
